    ...
    <xsl:template match="/">
        <ismrmrdHeader xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd"
            ...
            <subjectInformation>
                ...
                <patientID>
                    <xsl:value-of select="siemens/IRIS/RECOMPOSE/PatientLOID"/>
                </patientID>
                <patientGender>
                    <xsl:choose>
		...
		<xsl:for-each select="siemens/MEAS/sWipMemBlock/adFree">
			...
			<userParameterDouble>
                ...
                <!-- Measurement info -->
                <xsl:if test="siemens/MEAS/tProtocolName">
                    <userParameterString>
                        <name>tProtocolName</name>
                        <value>
                            <xsl:value-of select="siemens/MEAS/tProtocolName"/>
                        </value>
                    </userParameterString>
                ...
                <xsl:if test="siemens/HEADER/MeasUID">
                    <userParameterString>
                        <name>MeasUID</name>
                        <value>
                            <xsl:value-of select="siemens/HEADER/MeasUID"/>
                        </value>
                    </userParameterString>
                </xsl:if>

                <xsl:if test="siemens/HEADER/PatientLOID">
                    <userParameterString>
                        <name>PatientLOID</name>
                        <value>
                            <xsl:value-of select="siemens/HEADER/PatientLOID"/>
                        </value>
                    </userParameterString>
                </xsl:if>

                <xsl:if test="siemens/HEADER/StudyLOID">
                    <userParameterString>
                        <name>StudyLOID</name>
                        <value>
                            <xsl:value-of select="siemens/HEADER/StudyLOID"/>
                        </value>
                    </userParameterString>
                </xsl:if>

                <xsl:if test="siemens/HEADER/tStudyDescription">
                    <userParameterString>
                        <name>tStudyDescription</name>
                        <value>
                            <xsl:value-of select="siemens/HEADER/tStudyDescription"/>
                        </value>
                    </userParameterString>
                </xsl:if>
