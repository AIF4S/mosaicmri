        ...
        <ismrmrdHeader xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd"
          ...
          <userParameters>
            <xsl:if test="siemens/MEAS/sAngio/sFlowArray/lSize">
              ...
              <userParameterLong>
                <name>Flow_Dir_0</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s0/nDir" />
                </value>
              </userParameterLong>
            </xsl:if>
			<xsl:if test="siemens/MEAS/sAngio/sFlowArray/lSize > 1">
              <userParameterLong>
                <name>VENC_1</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s1/nVelocity" />
                </value>
              </userParameterLong>

              <userParameterLong>
                <name>Flow_Dir_1</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s1/nDir" />
                </value>
              </userParameterLong>
            </xsl:if>
			<xsl:if test="siemens/MEAS/sAngio/sFlowArray/lSize > 2">
              <userParameterLong>
                <name>VENC_2</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s2/nVelocity" />
                </value>
              </userParameterLong>

              <userParameterLong>
                <name>Flow_Dir_2</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s2/nDir" />
                </value>
              </userParameterLong>
            </xsl:if>
			
			<xsl:if test="siemens/MEAS/sAngio/sFlowArray/lSize > 3">
              <userParameterLong>
                <name>VENC_3</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s3/nVelocity" />
                </value>
              </userParameterLong>

              <userParameterLong>
                <name>Flow_Dir_3</name>
                <value>
                  <xsl:value-of select="siemens/MEAS/sAngio/sFlowArray/asElm/s3/nDir" />
                </value>
              </userParameterLong>
            </xsl:if>
		 ...
		 <userParameterDouble>
            ...
            <!-- Bilal user parameters -->
                <xsl:if test="siemens/YAPS/tSequenceString">
                    <userParameterString>
                        <name>tSequenceString</name>
                        <value>
                            <xsl:value-of select="siemens/YAPS/tSequenceString" />
                        </value>
                    </userParameterString>
                </xsl:if>
                <xsl:if test="siemens/DICOM/tSequenceVariant">
                    <userParameterString>
                        <name>tSequenceVariant</name>
                        <value>
                            <xsl:value-of select="siemens/DICOM/tSequenceVariant" />
                        </value>
                    </userParameterString>
                </xsl:if>
                <!-- Bilal user parameters -->
