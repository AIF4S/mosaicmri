...
CUDA_VISIBLE_DEVICES=0 python run_pretrained_varnet_inference.py --data_path $MSK_DATASET \
  --output_path ./outputs/finetune_fastmri-msk/msk_casc8_acc4_15 \
  --state_dict_file ./logs/varnet_mskmrpro_finetune_casc8_acc4/epoch=15.ckpt \

CUDA_VISIBLE_DEVICES=0 python run_pretrained_varnet_inference.py --data_path $FASTMRI_DATASET \
  --output_path ./outputs/finetune_fastmri-msk/fastmri_casc8_acc4_15 \
  --state_dict_file ./logs/varnet_mskmrpro_finetune_casc8_acc4/epoch=15.ckpt \