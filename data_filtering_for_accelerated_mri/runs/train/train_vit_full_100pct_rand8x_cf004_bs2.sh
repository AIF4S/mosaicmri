...
CUDA_VISIBLE_DEVICES=2 python run_end2end_baseline_direct.py \
  --model vit \
  ...
  --run_name msk_vit_large_full_random_cf004_acc8_bs2 \
  --mask_type random \
  ...
  --wandb_name msk_vit_large_full_random_cf004_acc8_bs2 \
  --wandb_log_images \
  --wandb_num_images 4 \
  --skip_eval
