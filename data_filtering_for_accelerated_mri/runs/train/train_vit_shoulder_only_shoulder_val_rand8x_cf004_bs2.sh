...
CUDA_VISIBLE_DEVICES=0 python run_end2end_baseline_direct.py \
  ...
  --run_name msk_vit_large_shoulder_only_random_cf004_acc8_bs2 \
  --category_mapping_path /data/datasets/msk_mri_h5/file_category_mapping.json \
  --train_anatomy SHOULDER \
  --val_anatomy SHOULDER \
  --mask_type random \
  ...
  --wandb_name msk_vit_large_shoulder_only_random_cf004_acc8_bs2 \
  --wandb_log_images \
  --wandb_num_images 4 \
  --skip_eval
