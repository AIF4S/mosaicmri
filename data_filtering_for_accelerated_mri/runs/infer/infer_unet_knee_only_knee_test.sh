...
CUDA_VISIBLE_DEVICES=0 python run_end2end_baseline_inference_rss_only_h5.py \
  --model u-net \
  ...
  --anatomy KNEE \
  --output_path "${REPO_DIR}/output/${RUN_NAME}/inference_knee_test_metrics_png" \
  --device cuda \
  --num_workers 16 \
  --num_png_samples 24 \
  --unet_chans 128 \
